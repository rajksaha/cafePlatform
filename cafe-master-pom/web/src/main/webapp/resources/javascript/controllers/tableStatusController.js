app.controller('TableStatusController', function($scope, $rootScope, $location, $stateParams, $state, $http, $timeout, ReportSetupService, $modal) {
    ...
    $scope.init = function() {
        ...
        $scope.searchData.entityStartDate = new Date();
        $scope.searchData.entityEndDate = new Date();
